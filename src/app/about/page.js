...
export default function About() {
  return (
    <main className="px-[20px] h-full bg-black text-white text-[1.4rem] [@media(min-height:700px)_and_(max-width:640px)]:text-[1.4rem] sm:text-2xl xl:text-3xl font-bold leading-5 sm:leading-7 flex flex-col gap-[25.37px]">
      <p className="mt-[25px]">
        ...
        impossible to ignore. With over 20 trusted brand partnerships under our
